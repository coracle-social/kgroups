...
/** NIP-29 event kinds */
export declare const NIP29_KINDS: {
    readonly CHAT_MESSAGE: 9;
    readonly CHAT_REPLY: 10;
    readonly TEXT_NOTE: 11;
    readonly TEXT_REPLY: 12;
    readonly MOD_ADD_USER: 9000;
    readonly MOD_REMOVE_USER: 9001;
    readonly MOD_EDIT_METADATA: 9002;
    readonly MOD_DELETE_EVENT: 9005;
    readonly MOD_CREATE_GROUP: 9007;
    readonly MOD_DELETE_GROUP: 9008;
    readonly MOD_CREATE_INVITE: 9009;
...
/** Admin permissions */
export type AdminPermission = "add-user" | "edit-metadata" | "delete-event" | "remove-user" | "add-permission" | "remove-permission" | "edit-group-status" | "delete-group";
/** Group member */
...
export type ClientMessage = ["EVENT", Event] | ["REQ", string, ...NostrFilter[]] | ["CLOSE", string] | ["AUTH", Event];
/** Relay-to-client message types */
export type RelayMessage = ["EVENT", string, Event] | ["OK", EventId, boolean, string] | ["EOSE", string] | ["CLOSED", string, string] | ["NOTICE", string] | ["AUTH", string];
/** Nostr filter */
